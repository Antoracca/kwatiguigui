  ...
  return (
    <div className="flex w-full flex-col gap-1.5">
      ...
      <SelectPrimitive.Trigger
        ...
        id={triggerId}
        className={cn(
          "flex h-11 w-full items-center justify-between rounded-lg border px-4 py-2",
          "bg-white text-body-md text-neutral-900",
      ...
      {error && (
        <p className="text-body-xs text-error-500" role="alert">
          {error}
        </p>
      )}
    </div>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-body-xs font-semibold uppercase tracking-wider text-neutral-400",
      className,
    )}
    {...props}
  />
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-lg py-2 pl-8 pr-4 text-body-sm",
      "text-neutral-900 dark:text-neutral-100",
      "outline-none transition-colors",
      "focus:bg-primary-50 focus:text-primary-700",
      "dark:focus:bg-primary-950 dark:focus:text-primary-300",
